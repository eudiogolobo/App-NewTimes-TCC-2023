...
begin
  total:= total + dm.qmensalidadevalorpago.value;
  dm.qmensalidade.Next;
end;

frm_imprimir_valorizacao.valor.caption:= formatfloat('#,,0.00', total);

frm_imprimir_valorizacao.inicio.caption:= datetostr(dtp1.Date);
frm_imprimir_valorizacao.fim.caption:= datetostr(dtp2.Date);
