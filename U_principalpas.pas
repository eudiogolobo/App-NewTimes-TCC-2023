...
MakeRounded(pnl_perfil);
 ...
 begin
     ...
     open;
     //statusbar1.Panels[0].Text:=('USUÁRIO LOGADO: ')+ dm.qusuariosnome.Value;
...
grava10:string;
begin
if sp1.Caption='CADASTRO DE MATRÍCULAS' then
  BEGIN
    AltDelAluno:=3;
  ...
  if sp1.Caption='ALTERAÇÃO DE MATRÍCULAS' then
  BEGIN
         AltDelMatricula:=1;
  ...
  if sp1.Caption='EXCLUSÃO DE MATRÍCULAS' then
  BEGIN
    AltDelMatricula:=2;
  ...
  if sp1.Caption='ALTERAÇÃO DE ALUNOS' then
  BEGIN
      AltDelAluno:=1;
  ...
  if sp1.Caption='EXCLUSÃO DE ALUNOS' then
  BEGIN
     AltDelAluno:=2;
  ...
  END;
    ...
    if sp1.Caption='ALTERAÇÃO DE CURSOS' then
  BEGIN
    AltDelCurso:=1;
  ...
  END;
     ...
     if sp1.Caption='EXCLUSÃO DE CURSOS' then
  BEGIN
         AltDelCurso:=2;
  ...
  END;
     ...
     if sp1.Caption='ALTERAÇÃO DE TURMAS' then
  BEGIN
    AltDelTurma:=1;
  ...
  END;
     ...
     if sp1.Caption='EXCLUSÃO DE TURMAS' then
  BEGIN
      AltDelTurma:=2;
  ...
  END;
      ...
      if sp1.Caption='ALTEREÇÃO DE PROFESSORES' then
  BEGIN
     AltDelProfessor:=1;
  ...
  END;
      ...
      if sp1.Caption='EXCLUSÃO DE PROFESSORES' then
  BEGIN
      AltDelProfessor:=2;
  ...
  END;
        ...
        if sp1.Caption='RELAÇÃO ALUNOS/ TURMA' then
  BEGIN
     AltDelTurma:=3;
  ...
  END;
        ...
        if sp1.Caption='CADASTRO DE AVALIAÇÕES' then
  BEGIN
  ...
  END;
          ...
          if sp1.Caption='ALTERAÇÃO DE AVALIAÇÕES' then
  BEGIN
  ...
  END;
          ...
          if sp1.Caption='EXCLUSÃO DE AVALIAÇÕES' then
  BEGIN
  ...
  END;
          ...
          if sp1.Caption='LANÇAMENTO DE NOTAS' then
  BEGIN
  ...
  END;
            ...
            if sp1.Caption='VIZUALIZAÇÃO DE NOTAS' then
  BEGIN
   AltDelTurma:=4;
  ...
  END;
            ...
            if sp1.Caption='CADASTRO DE USUÁRIOS' then
  BEGIN
  ...
  END;
            ...
            if sp1.Caption='ALTERAÇÃO DE USUÁRIOS' then
  BEGIN
     AltDelUser:=1;
  ...
  END;
              ...
              if sp1.Caption='EXCLUSÃO DE USUÁRIOS' then
  BEGIN
    AltDelUser:=2;
...
omds:string;
begin
if sp2.Caption='CADASTRO DE MATRÍCULAS' then
  BEGIN
    AltDelAluno:=3;
  ...
  if sp2.Caption='ALTERAÇÃO DE MATRÍCULAS' then
  BEGIN
         AltDelMatricula:=1;
  ...
  if sp2.Caption='EXCLUSÃO DE MATRÍCULAS' then
  BEGIN
    AltDelMatricula:=2;
  ...
  if sp2.Caption='ALTERAÇÃO DE ALUNOS' then
  BEGIN
      AltDelAluno:=1;
  ...
  if sp2.Caption='EXCLUSÃO DE ALUNOS' then
  BEGIN
     AltDelAluno:=2;
  ...
  END;
    ...
    if sp2.Caption='ALTERAÇÃO DE CURSOS' then
  BEGIN
    AltDelCurso:=1;
  ...
  END;
     ...
     if sp2.Caption='EXCLUSÃO DE CURSOS' then
  BEGIN
         AltDelCurso:=2;
  ...
  END;
     ...
     if sp2.Caption='ALTERAÇÃO DE TURMAS' then
  BEGIN
    AltDelTurma:=1;
  ...
  END;
     ...
     if sp2.Caption='EXCLUSÃO DE TURMAS' then
  BEGIN
      AltDelTurma:=2;
  ...
  END;
      ...
      if sp2.Caption='ALTEREÇÃO DE PROFESSORES' then
  BEGIN
     AltDelProfessor:=1;
  ...
  END;
      ...
      if sp2.Caption='EXCLUSÃO DE PROFESSORES' then
  BEGIN
      AltDelProfessor:=2;
  ...
  END;
        ...
        if sp2.Caption='RELAÇÃO ALUNOS/ TURMA' then
  BEGIN
     AltDelTurma:=3;
  ...
  END;
        ...
        if sp2.Caption='CADASTRO DE AVALIAÇÕES' then
  BEGIN
     CadAltDelAvaliacao:=1;
    frm_pesq_turma_professor := Tfrm_pesq_turma_professor.Create(Self);
  ...
  END;
          ...
          if sp2.Caption='ALTERAÇÃO DE AVALIAÇÕES' then
  BEGIN
       CadAltDelAvaliacao:=2;
  ...
  END;
          ...
          if sp2.Caption='EXCLUSÃO DE AVALIAÇÕES' then
  BEGIN
        CadAltDelAvaliacao:=3;
  frm_pesq_turma_professor := Tfrm_pesq_turma_professor.Create(Self);
  ...
  END;
          ...
          if sp2.Caption='LANÇAMENTO DE NOTAS' then
  BEGIN
       CadAltDelAvaliacao:=4;
  frm_pesq_turma_professor := Tfrm_pesq_turma_professor.Create(Self);
  ...
  END;
            ...
            if sp2.Caption='VIZUALIZAÇÃO DE NOTAS' then
  BEGIN
   AltDelTurma:=4;
  ...
  END;
            ...
            if sp2.Caption='CADASTRO DE USUÁRIOS' then
  BEGIN
      frm_caduser := Tfrm_caduser.Create(Self);
  ...
  END;
            ...
            if sp2.Caption='ALTERAÇÃO DE USUÁRIOS' then
  BEGIN
     AltDelUser:=1;
  ...
  if sp2.Caption='EXCLUSÃO DE USUÁRIOS' then
  BEGIN
    AltDelUser:=2;
...
gravando3:string;
begin
if sp3.Caption='CADASTRO DE MATRÍCULAS' then
  BEGIN
    AltDelAluno:=3;
  ...
  if sp3.Caption='ALTERAÇÃO DE MATRÍCULAS' then
  BEGIN
         AltDelMatricula:=1;
  ...
  if sp3.Caption='EXCLUSÃO DE MATRÍCULAS' then
  BEGIN
    AltDelMatricula:=2;
  ...
  if sp3.Caption='ALTERAÇÃO DE ALUNOS' then
  BEGIN
      AltDelAluno:=1;
  ...
  if sp3.Caption='EXCLUSÃO DE ALUNOS' then
  BEGIN
     AltDelAluno:=2;
  ...
  END;
    ...
    if sp3.Caption='ALTERAÇÃO DE CURSOS' then
  BEGIN
    AltDelCurso:=1;
  ...
  END;
     ...
     if sp3.Caption='EXCLUSÃO DE CURSOS' then
  BEGIN
         AltDelCurso:=2;
  ...
  END;
     ...
     if sp3.Caption='ALTERAÇÃO DE TURMAS' then
  BEGIN
    AltDelTurma:=1;
  ...
  END;
     ...
     if sp3.Caption='EXCLUSÃO DE TURMAS' then
  BEGIN
      AltDelTurma:=2;
  ...
  END;
      ...
      if sp3.Caption='ALTEREÇÃO DE PROFESSORES' then
  BEGIN
     AltDelProfessor:=1;
  ...
  END;
      ...
      if sp3.Caption='EXCLUSÃO DE PROFESSORES' then
  BEGIN
      AltDelProfessor:=2;
  ...
  END;
        ...
        if sp3.Caption='RELAÇÃO ALUNOS/ TURMA' then
  BEGIN
     AltDelTurma:=3;
  ...
  END;
        ...
        if sp3.Caption='CADASTRO DE AVALIAÇÕES' then
  BEGIN
     CadAltDelAvaliacao:=1;
    frm_pesq_turma_professor := Tfrm_pesq_turma_professor.Create(Self);
  ...
  END;
          ...
          if sp3.Caption='ALTERAÇÃO DE AVALIAÇÕES' then
  BEGIN
       CadAltDelAvaliacao:=2;
  ...
  END;
          ...
          if sp3.Caption='EXCLUSÃO DE AVALIAÇÕES' then
  BEGIN
        CadAltDelAvaliacao:=3;
  frm_pesq_turma_professor := Tfrm_pesq_turma_professor.Create(Self);
  ...
  END;
          ...
          if sp3.Caption='LANÇAMENTO DE NOTAS' then
  BEGIN
       CadAltDelAvaliacao:=4;
  frm_pesq_turma_professor := Tfrm_pesq_turma_professor.Create(Self);
  ...
  END;
            ...
            if sp3.Caption='VIZUALIZAÇÃO DE NOTAS' then
  BEGIN
   AltDelTurma:=4;
  ...
  END;
            ...
            if sp3.Caption='CADASTRO DE USUÁRIOS' then
  BEGIN
      frm_caduser := Tfrm_caduser.Create(Self);
  ...
  END;
            ...
            if sp3.Caption='ALTERAÇÃO DE USUÁRIOS' then
  BEGIN
     AltDelUser:=1;
  ...
  END;
              ...
              if sp3.Caption='EXCLUSÃO DE USUÁRIOS' then
  BEGIN
    AltDelUser:=2;
...
gavandoo4:string;
begin
if sp4.Caption='CADASTRO DE MATRÍCULAS' then
  BEGIN
    AltDelAluno:=3;
  ...
  if sp4.Caption='ALTERAÇÃO DE MATRÍCULAS' then
  BEGIN
         AltDelMatricula:=1;
  ...
  if sp4.Caption='EXCLUSÃO DE MATRÍCULAS' then
  BEGIN
    AltDelMatricula:=2;
  ...
  if sp4.Caption='ALTERAÇÃO DE ALUNOS' then
  BEGIN
      AltDelAluno:=1;
  ...
  if sp4.Caption='EXCLUSÃO DE ALUNOS' then
  BEGIN
     AltDelAluno:=2;
  ...
  END;
    ...
    if sp4.Caption='ALTERAÇÃO DE CURSOS' then
  BEGIN
    AltDelCurso:=1;
  ...
  END;
     ...
     if sp4.Caption='EXCLUSÃO DE CURSOS' then
  BEGIN
         AltDelCurso:=2;
  ...
  END;
     ...
     if sp4.Caption='ALTERAÇÃO DE TURMAS' then
  BEGIN
    AltDelTurma:=1;
  ...
  END;
     ...
     if sp4.Caption='EXCLUSÃO DE TURMAS' then
  BEGIN
      AltDelTurma:=2;
  ...
  END;
      ...
      if sp4.Caption='ALTEREÇÃO DE PROFESSORES' then
  BEGIN
     AltDelProfessor:=1;
  ...
  END;
      ...
      if sp4.Caption='EXCLUSÃO DE PROFESSORES' then
  BEGIN
      AltDelProfessor:=2;
  ...
  END;
        ...
        if sp4.Caption='RELAÇÃO ALUNOS/ TURMA' then
  BEGIN
     AltDelTurma:=3;
  ...
  END;
        ...
        if sp4.Caption='CADASTRO DE AVALIAÇÕES' then
  BEGIN
     CadAltDelAvaliacao:=1;
    frm_pesq_turma_professor := Tfrm_pesq_turma_professor.Create(Self);
  ...
  END;
          ...
          if sp4.Caption='ALTERAÇÃO DE AVALIAÇÕES' then
  BEGIN
       CadAltDelAvaliacao:=2;
  ...
  END;
          ...
          if sp4.Caption='EXCLUSÃO DE AVALIAÇÕES' then
  BEGIN
        CadAltDelAvaliacao:=3;
  frm_pesq_turma_professor := Tfrm_pesq_turma_professor.Create(Self);
  ...
  END;
          ...
          if sp4.Caption='LANÇAMENTO DE NOTAS' then
  BEGIN
       CadAltDelAvaliacao:=4;
  frm_pesq_turma_professor := Tfrm_pesq_turma_professor.Create(Self);
  ...
  END;
            ...
            if sp4.Caption='VIZUALIZAÇÃO DE NOTAS' then
  BEGIN
   AltDelTurma:=4;
  ...
  END;
            ...
            if sp4.Caption='CADASTRO DE USUÁRIOS' then
  BEGIN
      frm_caduser := Tfrm_caduser.Create(Self);
  ...
  END;
            ...
            if sp4.Caption='ALTERAÇÃO DE USUÁRIOS' then
  BEGIN
     AltDelUser:=1;
  ...
  END;
              ...
              if sp4.Caption='EXCLUSÃO DE USUÁRIOS' then
  BEGIN
    AltDelUser:=2;
...
begin
 if sp5.Caption='CADASTRO DE MATRÍCULAS' then
  BEGIN
    AltDelAluno:=3;
  ...
  if sp5.Caption='ALTERAÇÃO DE MATRÍCULAS' then
  BEGIN
         AltDelMatricula:=1;
  ...
  if sp5.Caption='EXCLUSÃO DE MATRÍCULAS' then
  BEGIN
    AltDelMatricula:=2;
  ...
  if sp5.Caption='ALTERAÇÃO DE ALUNOS' then
  BEGIN
      AltDelAluno:=1;
  ...
  if sp5.Caption='EXCLUSÃO DE ALUNOS' then
  BEGIN
     AltDelAluno:=2;
  ...
  END;
    ...
    if sp5.Caption='ALTERAÇÃO DE CURSOS' then
  BEGIN
    AltDelCurso:=1;
  ...
  END;
     ...
     if sp5.Caption='EXCLUSÃO DE CURSOS' then
  BEGIN
         AltDelCurso:=2;
  ...
  END;
     ...
     if sp5.Caption='ALTERAÇÃO DE TURMAS' then
  BEGIN
    AltDelTurma:=1;
  ...
  END;
     ...
     if sp5.Caption='EXCLUSÃO DE TURMAS' then
  BEGIN
      AltDelTurma:=2;
  ...
  END;
      ...
      if sp5.Caption='ALTEREÇÃO DE PROFESSORES' then
  BEGIN
     AltDelProfessor:=1;
  ...
  END;
      ...
      if sp5.Caption='EXCLUSÃO DE PROFESSORES' then
  BEGIN
      AltDelProfessor:=2;
  ...
  END;
        ...
        if sp5.Caption='RELAÇÃO ALUNOS/ TURMA' then
  BEGIN
     AltDelTurma:=3;
  ...
  END;
        ...
        if sp5.Caption='CADASTRO DE AVALIAÇÕES' then
  BEGIN
     CadAltDelAvaliacao:=1;
    frm_pesq_turma_professor := Tfrm_pesq_turma_professor.Create(Self);
  ...
  END;
          ...
          if sp5.Caption='ALTERAÇÃO DE AVALIAÇÕES' then
  BEGIN
       CadAltDelAvaliacao:=2;
  ...
  END;
          ...
          if sp5.Caption='EXCLUSÃO DE AVALIAÇÕES' then
  BEGIN
        CadAltDelAvaliacao:=3;
  frm_pesq_turma_professor := Tfrm_pesq_turma_professor.Create(Self);
  ...
  END;
          ...
          if sp5.Caption='LANÇAMENTO DE NOTAS' then
  BEGIN
       CadAltDelAvaliacao:=4;
  frm_pesq_turma_professor := Tfrm_pesq_turma_professor.Create(Self);
  ...
  END;
            ...
            if sp5.Caption='VIZUALIZAÇÃO DE NOTAS' then
  BEGIN
   AltDelTurma:=4;
  ...
  END;
            ...
            if sp5.Caption='CADASTRO DE USUÁRIOS' then
  BEGIN
      frm_caduser := Tfrm_caduser.Create(Self);
  ...
  END;
            ...
            if sp5.Caption='ALTERAÇÃO DE USUÁRIOS' then
  BEGIN
     AltDelUser:=1;
  ...
  END;
              ...
              if sp5.Caption='EXCLUSÃO DE USUÁRIOS' then
  BEGIN
    AltDelUser:=2;
...
//statusbar1.Panels[1].Text:= ('Horário: ')+FormatDateTime ('hh:mm:ss',now);
end;
