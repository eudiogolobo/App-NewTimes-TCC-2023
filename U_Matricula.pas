...
VAR
situacao,data,valor:string;
h,a:integer;

begin
 if (combobox2.ItemIndex<>-1) and (cb1.ItemIndex<>-1) and (combobox3.ItemIndex<>-1) and (combobox1.ItemIndex<>-1) and (maskedit2.Text<>'') then
   begin
     ...
     WITH dm.qmatricula_cad do
       begin
         ...
         begin
           if (combobox2.ItemIndex<>-1) and (combobox3.ItemIndex<>-1) and (combobox1.ItemIndex<>-1) and (maskedit2.Text<>'') then
         begin
           ...
           valor:=floattostr(mensalidade);

           for h:=1 to combobox3.itemindex+1 do
           begin
            for a := 0 to length(valor) do
            begin
               if valor[a]=',' then
               begin
                 strtofloat(formatfloat('#,,0.00',mensalidade))
               end;
