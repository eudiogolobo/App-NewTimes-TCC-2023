      ...
      item:=COMBOBOX1.ItemIndex;
       ...
       2: begin
          ...
          frm_impressao_contrato_matricula.rlmemo2.lines.Clear;
            ...
            frm_impressao_contrato_matricula.rlmemo2.Lines.Add(#13+#13+'_______________________________'+#13+'Assinatura do Contratante'+#13+#13+'_______________________________'+#13+'Assinatura do Representante legal da Contratada'+#13+#13+'Nome: __________________________________, RG Nº _______________________________'+#13+#13+'_______________________________'+#13+'Assinatura da Testemunha 1'+#13+#13+'Nome: __________________________________, RG Nº _______________________________'+#13+#13+'_______________________________'+#13+'Assinatura da Testemunha 2');
