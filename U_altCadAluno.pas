...
with dm.qalunos do
  begin
    ...
    if (dm.qalunosestado_civil.text)='VIÚVO(A)' then
    cb3.ItemIndex:=3;
    ...
    cb3.ItemIndex:=6;
  /////////////////////////////////////////
     if (dm.qalunoscor_raca.text)='NÃO DECLARADA' then
    cb1.ItemIndex:=0;
    ...
    cb1.ItemIndex:=4;
       ...
       if (dm.qalunoscor_raca.text)='INDÍGENA' then
    cb1.ItemIndex:=5;
...
/////////////////////// CARREGANDO ENDEREÇO /////////////////
 ...
 begin
   ...
   begin
     ...
     // MUNICÍPIO
     if (dm.qenderecomunicipio.Text)='CRICIÚMA' then
     cb5.ItemIndex:=0;
     if (dm.qenderecoMUNICIPIO.Text)='IÇARA' then
     cb5.ItemIndex:=1;
 ...
 ////// CARREGANDO RESPONSAVEIS ////////////
  BEGIN
   ...
   begin
     ...
     // Identificação f1
     if (dm.qresponsaveisf1id.text)='MÃE' then
     begin
