...
type
  Tfrm_alt_avaliacao = class(TForm)
    Panel2: TPanel;
    Label12: TLabel;
    Label4: TLabel;
    Panel35: TPanel;
...
var
  frm_alt_avaliacao: Tfrm_alt_avaliacao;

implementation

{$R *.dfm}
uses
u_dm, u_inicio,u_principalpas, u_principal_professor;

procedure Tfrm_alt_avaliacao.btn_salvarClick(Sender: TObject);
begin
 ...
 begin
  ...
  with dm.tbavaliacao do
   begin
     close;
     sql.Clear;
     sql.Add('update avaliacao set Tipo= :Tipo , ModuloRef= :ModuloRef , TotalAulas= :TotalAulas , Descricao= :Descricao , data= :data where id = :idava');
...
procedure Tfrm_alt_avaliacao.FormCreate(Sender: TObject);
var
i:integer;
begin
...
procedure Tfrm_alt_avaliacao.FormMouseWheelDown(Sender: TObject;
...
procedure Tfrm_alt_avaliacao.FormMouseWheelUp(Sender: TObject;
  Shift: TShiftState; MousePos: TPoint; var Handled: Boolean);
begin
...
procedure Tfrm_alt_avaliacao.Panel2MouseMove(Sender: TObject;
...
procedure Tfrm_alt_avaliacao.ScrollBar1Change(Sender: TObject);
begin
