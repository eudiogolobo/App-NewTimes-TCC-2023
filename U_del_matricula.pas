...
begin
if MessageDlg('Você deseja mesmo excluír essa matrícula?',mtConfirmation,[mbyes, mbno],0)=mryes then
 BEGIN
...
procedure Tfrm_del_matricula.FormMouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
begin
...
procedure Tfrm_del_matricula.Panel2MouseMove(Sender: TObject;
