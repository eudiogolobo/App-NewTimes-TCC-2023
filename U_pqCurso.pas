...
begin
  ...
  begin
   ...
   if (cb2.ItemIndex<>-1) and (cb2.ItemIndex<>0)  then
   begin
        with dm.qcursos do
    begin
    close;
   ...
   if (cb1.ItemIndex<>0) and (cb1.ItemIndex<>-1)  then
   begin
   with dm.qcursos do
    begin
    close;
    ...
    if (cb1.ItemIndex<>0) and (cb1.ItemIndex<>-1) and  (cb2.ItemIndex<>0) and (cb2.ItemIndex<>-1) then
    begin
    with dm.qcursos do
    begin
    close;
