...
begin
  ...
  begin
    ...
    showmessage('Impossivel realizar essa operação.');
...
valorVerificador:=floattostr(dm.qmensalidadevalormensalidade.value);



for i:=0 to length(valorVerificador) do
    begin
     if valorVerificador[i]=',' then
     begin
   ...
   if edit1.Text='' then
   begin
     edit1.Text:= floattostr(dm.qmensalidadevalormensalidade.value);
   end;
