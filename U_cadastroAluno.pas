...
////////////////// ADICIONANDO EM DOCUMENTOS /////////////////////////////
  ...
  ///////////////// ADICIONANDO EM INFO. RESPONSSÁVEIS  ///////////////////////////
...
if (edit1.Text<>'') and (MASKEDIT7.Text<>'') and (MASKEDIT8.Text<>'') and (combobox10.ItemIndex<>-1) and (cb3.ItemIndex<>-1) and (edit2.Text<>'') and (maskedit1.Text<>'') and (cb1.ItemIndex<>-1) and (edit40.Text<>'') and (edit4.Text<>'') then
  ...
  BEGIN
  showmessage('ERRO: Campo obrigatório em branco!');
  //Panel2.Top:=0;
  END;
end;
...
begin
 ...
 zona:='RURAL';
  ...
  begin
    ...
    showmessage('ERRO: Campo obrigatório em branco em Endereço!')
    else
      begin
...
showmessage('ERRO: Campo obrigatório em branco em Documentos!')
else
begin
      with dm.tbdocumentos do
  begin
...
showmessage('ERRO: Campo obrigatório em branco em Responsáveis!')
else
begin
...
showmessage('ERRO: Campo obrigatório em branco em Saúde!')
else
begin
  with dm.tbsaude do
  begin
...
begin
 ////////////////// ADICIONANDO EM INFO. COMPLEMENTAR /////////////////////////////
  ...
  showmessage('ERRO: Campo obrigatório em branco em Info. Complementar!')
  else
  begin
  if radiobutton15.Checked=true then
 bs_fml:='SIM'
...
anexos:=false;
 ...
 if (save_rg=true) and (save_cpf=true) and (save_crt_nasc=true) and  (save_foto=true) and (save_comp_residencia=true) and (save_crt_vacina=true) and (OPD_rg.FileName<>'') and (OPD_cpf.FileName<>'') and (opd_certidao_nasc.FileName<>'') and (opd_foto.FileName<>'') and (opd_comp_residencia.FileName<>'') and (opd_vacina.FileName<>'') then
  ...
  begin
      ...
      begin
      showmessage('ERRO: Campo obrigatório em branco em Anexo De Documentos!');
      end;
...
BEGIN
  ...
  begin
   ...
   begin
     showmessage('ERRO: CPF já cadastrado!');
   end
    ...
    begin
     ...
     begin
      ...
      begin
        ...
        begin
          showmessage('ERRO: Campo obrigatório em branco em Informações De Identificação!');
        end
        else
        begin
        if (endereco=false) then
          begin
            showmessage('ERRO: Campo obrigatório em branco em Informações De Endereço!');
          end
        else
        begin
         if (documentos=false) then
          begin
          showmessage('ERRO: Campo obrigatório em branco em Informações Dos Documentos!');
          end
        else
        begin
          if (responsaveis=false) then
          begin
          showmessage('ERRO: Campo obrigatório em branco em Informações Dos Responsáveis!')
        end
        else
          begin
          if (saude=false) then
            begin
            showmessage('ERRO: Campo obrigatório em branco em Informações De Saúde!')
          ...
          begin
            ...
            begin
              showmessage('ERRO: Campo obrigatório em branco em InformaçÕes Complementares!')
            end
            else
