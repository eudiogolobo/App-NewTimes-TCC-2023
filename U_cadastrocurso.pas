...
begin
if (dbedit1.text<>'')  and (dbedit3.text<>'') and (dbedit4.text<>'') and (dbcombobox1.ItemIndex<>-1) and (dbedit6.text<>'') and (dbcombobox2.ItemIndex<>-1) and  (dbcombobox3.ItemIndex<>-1) and (dbedit8.text<>'') and (dbmemo1.text<>'') and (dbedit10.text<>'')then
 begin
