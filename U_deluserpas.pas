...
begin
if MessageDlg('Você deseja mesmo excluír esse usuário?',mtConfirmation,[mbyes, mbno],0)=mryes then
begin
...
if dm.tbuser.Locate('id', edit1.text,[]) then
 begin
 if MessageDlg('Você dejesa mesmo deletar o usuário?',mtConfirmation,[mbyes, mbno],0)=mryes then
    begin
    dm.tbuser.delete;
...
if dm.tbuser.Locate('id', edit1.text,[]) then
 begin
 if MessageDlg('Você confirma a exclusão desse usuário?',mtConfirmation,[mbyes, mbno],0)=mryes then
    begin
    dm.tbuser.delete;
...
if edit1.Text<>'' then
 begin
  ...
  if dm.tbuser.Locate('id', edit1.text,[]) then
   begin
   if MessageDlg('Você confirma o usuário?',mtConfirmation,[mbyes, mbno],0)=mryes then
    begin
      dm.tbuser.Edit;
