object frm_imprecao_atestadof: Tfrm_imprecao_atestadof
  Left = 0
  Top = 0
  Caption = 'IMPRIME ATESTADO'
  ClientHeight = 707
  ClientWidth = 800
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object imat: TRLReport
    Left = 0
    Top = 0
    Width = 794
    Height = 1123
    DataSource = dm.ds_AtestadoFrequencia
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clBlack
    Font.Height = -13
    Font.Name = 'Arial'
    ...
    object RLBand2: TRLBand
      ...
      object Label1: TLabel
        ...
        Width = 266
        Height = 22
        Caption = 'ATESTADO DE FREQU'#202'NCIA'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -19
        Font.Name = 'Arial'
      ...
      object RLLabel7: TRLLabel
        ...
        Width = 148
        Height = 16
        Caption = 'Situa'#231#227'o da matr'#237'cula:'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -13
        Font.Name = 'Arial'
